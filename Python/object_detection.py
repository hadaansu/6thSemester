...
exit_button_pos = (500, 20) # 500 pixels from the left 50 pixels from the top
exit_button_size = (120, 50) #120 button width ,50 button height

window_name = "Bottle Detection" #title of the opencv window
...
while running:
    ...
    for result in results:
        ...
        for box in result.boxes:
            ...
            label = model.names[cls_id] #yolo gives a numeric class id which come 
